...
const SI_TRANSLATIONS: Record<string, string> = {
  ...
  "Booking: ": "වෙන්කිරීම: ",
  "Journey Date: ": "ගමන් දිනය: ",
  // Added after a QA pass found these screens falling back to English because the
  // catalogue had no entry for them. Machine-assisted; worth a native review.
  "Review & Pay": "සමාලෝචනය කර ගෙවන්න",
  "Recent": "මෑත",
  "Mark all read": "සියල්ල කියවූ ලෙස සලකුණු කරන්න",
  "Loading notifications...": "දැනුම්දීම් පූරණය වෙමින්...",
  "No notifications to show.": "පෙන්වීමට දැනුම්දීම් නැත.",
  "Emergency Mode": "හදිසි ආකාරය",
  "Help is on the way, please be calm.": "උදව් පැමිණෙමින් පවතී, කරුණාකර සන්සුන් වන්න.",
  "Inform my emergency contacts": "මගේ හදිසි සම්බන්ධතාවලට දැනුම් දෙන්න",
  "Manage emergency contacts": "හදිසි සම්බන්ධතා කළමනාකරණය කරන්න",
  "Loading emergency numbers...": "හදිසි අංක පූරණය වෙමින්...",
  "Emergency contacts": "හදිසි සම්බන්ධතා",
  "No emergency contacts yet.": "තවම හදිසි සම්බන්ධතා නැත.",
  "Add contact": "සම්බන්ධතාවක් එක් කරන්න",
  "Add Emergency Contact": "හදිසි සම්බන්ධතාවක් එක් කරන්න",
  "Messages": "පණිවිඩ",
  "No conversations found.": "සංවාද හමු නොවීය.",
  "Past": "පසුගිය",
  "Reason for Cancellation": "අවලංගු කිරීමට හේතුව",
  "Keep Booking": "වෙන්කිරීම තබාගන්න",
  "Decline Admin Cancellation": "පරිපාලක අවලංගු කිරීම ප්‍රතික්ෂේප කරන්න",
  "Reason (Optional)": "හේතුව (විකල්ප)",
  "Dismiss": "ඉවත් කරන්න",
  "Decline Request": "ඉල්ලීම ප්‍රතික්ෂේප කරන්න",
  "Cancellation Requested": "අවලංගු කිරීම ඉල්ලා ඇත",
  "Admin Requested Cancellation": "පරිපාලක අවලංගු කිරීමක් ඉල්ලා ඇත",
  "Accept Cancel": "අවලංගු කිරීම පිළිගන්න",
  "Decline": "ප්‍රතික්ෂේප කරන්න",
  "Cancellation Request Rejected": "අවලංගු කිරීමේ ඉල්ලීම ප්‍රතික්ෂේප විය",
  "Request Cancellation Again": "නැවත අවලංගු කිරීම ඉල්ලන්න",
  "Pay Now": "දැන් ගෙවන්න",
  "Non-AC": "AC රහිත",
  "Hour": "පැය",
  "Minute": "මිනිත්තු",
  "Tap the number to type directly": "කෙලින්ම ටයිප් කිරීමට අංකය තට්ටු කරන්න",
  "Search pickup location...": "ගොඩවන ස්ථානය සොයන්න...",
  "Search drop-off location...": "බසින ස්ථානය සොයන්න...",
  "Live Tracking": "සජීවී නිරීක්ෂණය",
  "ETA": "පැමිණෙන වේලාව",
  "Distance": "දුර",
  "Speed": "වේගය",
  "ON ROUTE": "මාර්ගයේ",
  "OFF ROUTE": "මාර්ගයෙන් පිට",
  "You are on the bus": "ඔබ බස් රථයේ සිටී",
  "Waiting for bus location...": "බස් රථයේ ස්ථානය එනතුරු බලා සිටී...",
  "I've Alighted": "මම බැස්සා",
  "Are you on the bus?": "ඔබ බස් රථයේද?",
  "Yes, I'm on Board": "ඔව්, මම බස් රථයේ",
  "Not Yet": "තවම නැහැ",
};
...
const TA_TRANSLATIONS: Record<string, string> = {
  ...
  // Added after a QA pass found these screens falling back to English because the
  // catalogue had no entry for them. Machine-assisted; worth a native review.
  "Review & Pay": "மதிப்பாய்வு செய்து செலுத்துங்கள்",
  "Recent": "சமீபத்திய",
  "Mark all read": "அனைத்தையும் படித்ததாகக் குறிக்கவும்",
  "Loading notifications...": "அறிவிப்புகள் ஏற்றப்படுகின்றன...",
  "No notifications to show.": "காட்ட அறிவிப்புகள் இல்லை.",
  "Emergency Mode": "அவசர நிலை",
  "Help is on the way, please be calm.": "உதவி வந்துகொண்டிருக்கிறது, தயவுசெய்து அமைதியாக இருங்கள்.",
  "Inform my emergency contacts": "எனது அவசர தொடர்புகளுக்குத் தெரிவிக்கவும்",
  "Manage emergency contacts": "அவசர தொடர்புகளை நிர்வகிக்கவும்",
  "Loading emergency numbers...": "அவசர எண்கள் ஏற்றப்படுகின்றன...",
  "Emergency contacts": "அவசர தொடர்புகள்",
  "No emergency contacts yet.": "இன்னும் அவசர தொடர்புகள் இல்லை.",
  "Add contact": "தொடர்பைச் சேர்க்கவும்",
  "Add Emergency Contact": "அவசர தொடர்பைச் சேர்க்கவும்",
  "Messages": "செய்திகள்",
  "No conversations found.": "உரையாடல்கள் எதுவும் இல்லை.",
  "Past": "கடந்தவை",
  "Reason for Cancellation": "ரத்து செய்வதற்கான காரணம்",
  "Keep Booking": "முன்பதிவை வைத்திருங்கள்",
  "Decline Admin Cancellation": "நிர்வாக ரத்தை நிராகரிக்கவும்",
  "Reason (Optional)": "காரணம் (விருப்பத்தேர்வு)",
  "Dismiss": "நிராகரி",
  "Decline Request": "கோரிக்கையை நிராகரிக்கவும்",
  "Cancellation Requested": "ரத்து கோரப்பட்டது",
  "Admin Requested Cancellation": "நிர்வாகம் ரத்தைக் கோரியுள்ளது",
  "Accept Cancel": "ரத்தை ஏற்கவும்",
  "Decline": "நிராகரிக்கவும்",
  "Cancellation Request Rejected": "ரத்து கோரிக்கை நிராகரிக்கப்பட்டது",
  "Request Cancellation Again": "மீண்டும் ரத்தைக் கோரவும்",
  "Pay Now": "இப்போது செலுத்துங்கள்",
  "Non-AC": "ஏசி இல்லாத",
  "Hour": "மணி",
  "Minute": "நிமிடம்",
  "Tap the number to type directly": "நேரடியாக தட்டச்சு செய்ய எண்ணைத் தட்டவும்",
  "Search pickup location...": "ஏறும் இடத்தைத் தேடுங்கள்...",
  "Search drop-off location...": "இறங்கும் இடத்தைத் தேடுங்கள்...",
  "Live Tracking": "நேரடி கண்காணிப்பு",
  "ETA": "வரும் நேரம்",
  "Distance": "தூரம்",
  "Speed": "வேகம்",
  "ON ROUTE": "பாதையில்",
  "OFF ROUTE": "பாதைக்கு வெளியே",
  "You are on the bus": "நீங்கள் பேருந்தில் உள்ளீர்கள்",
  "Waiting for bus location...": "பேருந்தின் இருப்பிடத்திற்காகக் காத்திருக்கிறது...",
  "I've Alighted": "நான் இறங்கிவிட்டேன்",
  "Are you on the bus?": "நீங்கள் பேருந்தில் இருக்கிறீர்களா?",
  "Yes, I'm on Board": "ஆம், நான் ஏறிவிட்டேன்",
